...
<script type="text/javascript" src="http://maps.googleapis.com/maps/api/js?key=AIzaSyCX1SGbjQbXFBLjBa-6BQtE6TWZ-Vi6oGI"></script>
    ...
    function load() {
      ...
      var infoWindow = new google.maps.InfoWindow;
          ...
          var point = new google.maps.LatLng(parseFloat('<?php echo $lat;?>'), parseFloat('<?php echo $long;?>'));
          var html = "";
          var icon =  {icon:  webroot+'img/icon1.png',shadow: 'http://labs.google.com/ridefinder/images/mm_20_shadow.png'};
