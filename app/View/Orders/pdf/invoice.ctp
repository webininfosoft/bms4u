...
<div id="wrapper">
    ...
    <tr>
    <td width="25%"><img src="<?php echo $this->Html->Url('/');?>/img/AVDHI8.png" height="" width="" name="" alt="logo"></td><td colspan="2" width="75%">AvdhiCR</td>
    <tr><td colspan="3"></tr>
    </tr>
    </table>
    <table class="heading" style="width:100%;">
        <tr>
            <td style="width:80mm;">
                <h1 class="heading"><?php echo $userdata['UserProfile']['first_name']; ?></h1>
                <h2 class="heading"><br />
                    <?php echo $userdata['UserProfile']['address']?>
                    Region , Country<br />
                     
                    Website : <?php echo $userdata['UserProfile']['url'] ?><br />
                    E-mail : <?php echo $userdata['UserProfile']['email']?><br />
                    Phone : <?php echo $userdata['UserProfile']['phone']?>
                </h2>
            </td>
