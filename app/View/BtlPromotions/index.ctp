...
<div class="row">
	...
	<?php foreach($arrBtlPromotionDetail as $val) {?>
			<tr class="odd">
				...
				<td> 
					<a href="<?php echo $this->Html->Url('/');?>apis/uploads/merchant/<?php echo $val['p']['btl_image'];?>"  class="fancybox" > <img src="<?php echo $this->Html->Url('/');?>apis/uploads/merchant/<?php echo $val['p']['btl_image'];?>" width="250" height="130" /></a>
                 
                    </td>
               <td>
                <p> Name:<br /> <?php echo  $val['u']['first_name'] ."\n". $val['u']['last_name'];  ?></p>
